...
# Author: CGP David
# Usage: 
# powershell -exec bypass -c "(new-object net.webclient).DownloadFile('https://raw.githubusercontent.com/cgpdavid/public_files/main/wipe_bloat_mcafee.ps1','wipe_bloat_mcafee.ps1'); ./wipe_bloat_mcafee.ps1"
#
